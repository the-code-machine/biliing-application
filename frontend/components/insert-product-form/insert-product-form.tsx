import { insertProductMutationHandler } from "@/action-handlers/mutation.handlers";
...
import { ProductForm, ProductFormType } from "../../utils/form-types.utils";
...
export default function InsertProductForm({
    ...
    const submiitMutation = useSWRMutation({
        ...
        async (_, { arg }: {
            ...
            const imageData = arg.image?.[0] ? {
                name: arg.image[0].name,
                buffer: Buffer.from(await arg.image[0].arrayBuffer()),
            } : undefined;
            insertProductMutationHandler({
                ...arg,
                image: imageData,
            });
        }, {
